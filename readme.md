# Person Marking in South-Central Trans-Himalayan: Nungthangtampak Kom

This PARALEX set contains person markers in Nunthangtampak Kom, including inflected verbal forms and pronouns. It constitutes part of the PMST (Person Marking in South-Central Trans-Himalayan) database.
...
## Additional information specific to Nunthangtampak Kom

* Tone: Tone is unmarked, as tonal analysis is still pending.
* Mapping between database paradigm labels and Nungthangtampak descriptive labels based on Aimol 2007:
...
a) formal (unfused) vs. informal (fused) in the negative paradigm: The informal forms are used in daily colloquial speech, whereas the formal forms are used in formal events like community gatherings, church service etc., and also in written form.

    * e.g., mǝk-uŋ vs. muŋ and mu-ǝŋ vs. muŋ. 
    
b) sociolect variation between nǝ- and ni- in the affirmative paradigm: Speakers claimed that both nǝ- and ni- are same. But based on the metadata of Nungthangtampak, usually the younger speakers use nǝ-, whereas the older speakers use ni-.
c) optional SAP\_O: a speaker occasionally gave forms without the SAP\_O marker.
d) optional plural: a speaker occasionally gave forms without the marking the third person plural.
